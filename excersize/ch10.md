...
int main()
{
    ...
    auto pivot = std::partition(v.begin(), v.end(), predicate);// 返回尾迭代器
...
int main()
{
    ...
    std::cout << count_if(authors.cbegin(), authors.cend(), bind(isLesserThanOrEqualTo6, _1, 6));//_1 是check size的参数
}
```
